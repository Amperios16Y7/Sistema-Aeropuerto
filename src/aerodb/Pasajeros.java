...
public class Pasajeros extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Pasajeros.class.getName());

    /**
     * Creates new form Pasajeros
     */
    
    String nombreTabla = "Pasajeros";
    DefaultTableModel modelo;
    int idRol;
    public Pasajeros(int idRol) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aerodb/group.png"))); // NOI18N
    ...
    private void btnAgregarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAgregarMouseClicked
        ...
        if (valores != null && cor) {
            ...
            JOptionPane.showMessageDialog(null, "Por favor asegurese que el correo termine con @gmail.com", "Advertencia", JOptionPane.WARNING_MESSAGE);
            return;
        }
