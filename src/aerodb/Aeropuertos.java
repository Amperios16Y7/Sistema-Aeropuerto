...
public class Aeropuertos extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Aeropuertos.class.getName());

    /**
     * Creates new form AeroPrueba
     */
    
    int idRol;
    String nombreTabla = "Aeropuertos";
    DefaultTableModel modelo;
    
    public Aeropuertos(int idRol) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aerodb/Airports.png"))); // NOI18N
